...
( function () {
	...
	var translateHelperGeometry = new THREE.BufferGeometry();
	translateHelperGeometry.addAttribute('position', new THREE.Float32BufferAttribute( [ 0, 0, 0, 1, 1, 1 ], 3 ) );

	var planeBufferGeometry = new THREE.PlaneBufferGeometry( 0.295, 0.295 );
	var octahedronGeometry = new THREE.OctahedronBufferGeometry( 0.1, 0 );
	var cylinderBufferGeometry = new THREE.CylinderBufferGeometry( 0.2, 0, 1, 4, 1, false );
	var planeBufferGeometry2 = new THREE.PlaneBufferGeometry( 0.4, 0.4 );
	var octahedronGeometry2 = new THREE.OctahedronBufferGeometry( 0.2, 0 );
	var octahedronGeometry3 = new THREE.OctahedronBufferGeometry( 0.01, 2 );
	var octahedronGeometry4 = new THREE.OctahedronBufferGeometry( 0.04, 0 );
	var circleGeometry = CircleGeometry( 1, 0.5 );
	var circleGeometry2 = CircleGeometry( 1.25, 1 );
	var circleGeometry3 = CircleGeometry( 1, 1 );
	var cylinderBufferGeometry2 = new THREE.CylinderBufferGeometry( 0.03, 0, 0.15, 4, 1, false );
	var torusBufferGeometry = new THREE.TorusBufferGeometry( 1, 0.1, 4, 24 );
	var torusBufferGeometry2 =new THREE.TorusBufferGeometry( 1.25, 0.1, 2, 24 );
	var sphereBufferGeometry = new THREE.SphereBufferGeometry( 0.7, 10, 8 );
	var boxBufferGeometry = new THREE.BoxBufferGeometry( 0.125, 0.125, 0.125 );
	var cylinderBufferGeometry = new THREE.CylinderBufferGeometry( 0.2, 0, 0.8, 4, 1, false );
	var boxBufferGeometry2 = new THREE.BoxBufferGeometry( 0.2, 0.2, 0.2 );
	...
	THREE.TransformControls = function ( camera, domElement ) {
		...
		this.pointerUp = function( pointer ) {
			...
			if ( this.dragging && ( this.axis !== null ) ) {
				...
				this.dispatchEvent( Object.assign( mouseUpEvent, { mode: this.mode } ) );
	...
	THREE.TransformControlsGizmo = function () {
		...
		var gizmoTranslate = {
			...
			XYZ: [
				[ new THREE.Mesh( octahedronGeometry, matWhiteTransperent ), [ 0, 0, 0 ], [ 0, 0, 0 ] ]
			],
			XY: [
				[ new THREE.Mesh( planeBufferGeometry, matYellowTransparent ), [ 0.15, 0.15, 0 ] ],
				[ new THREE.Line( lineGeometry, matLineYellow ), [ 0.18, 0.3, 0 ], null, [ 0.125, 1, 1 ] ],
				[ new THREE.Line( lineGeometry, matLineYellow ), [ 0.3, 0.18, 0 ], [ 0, 0, Math.PI / 2 ], [ 0.125, 1, 1 ] ]
			],
			YZ: [
				[ new THREE.Mesh( planeBufferGeometry, matCyanTransparent ), [ 0, 0.15, 0.15 ], [ 0, Math.PI / 2, 0 ] ],
				[ new THREE.Line( lineGeometry, matLineCyan ), [ 0, 0.18, 0.3 ], [ 0, 0, Math.PI / 2 ], [ 0.125, 1, 1 ] ],
				[ new THREE.Line( lineGeometry, matLineCyan ), [ 0, 0.3, 0.18 ], [ 0, -Math.PI / 2, 0 ], [ 0.125, 1, 1 ] ]
			],
			XZ: [
				[ new THREE.Mesh( planeBufferGeometry, matMagentaTransparent ), [ 0.15, 0, 0.15 ], [ -Math.PI / 2, 0, 0 ] ],
		...
		var pickerTranslate = {
			X: [
				[ new THREE.Mesh( cylinderBufferGeometry, matInvisible ), [ 0.6, 0, 0 ], [ 0, 0, -Math.PI / 2 ] ]
			],
			Y: [
				[ new THREE.Mesh( cylinderBufferGeometry, matInvisible ), [ 0, 0.6, 0 ] ]
			],
			Z: [
				[ new THREE.Mesh( cylinderBufferGeometry, matInvisible ), [ 0, 0, 0.6 ], [ Math.PI / 2, 0, 0 ] ]
			],
			XYZ: [
				[ new THREE.Mesh( octahedronGeometry2, matInvisible ) ]
			],
			XY: [
				[ new THREE.Mesh( planeBufferGeometry2, matInvisible ), [ 0.2, 0.2, 0 ] ]
			],
			YZ: [
				[ new THREE.Mesh( planeBufferGeometry2, matInvisible ), [ 0, 0.2, 0.2 ], [ 0, Math.PI / 2, 0 ] ]
			],
			XZ: [
				[ new THREE.Mesh( planeBufferGeometry2, matInvisible ), [ 0.2, 0, 0.2 ], [ -Math.PI / 2, 0, 0 ] ]
			]
		};

		var helperTranslate = {
			START: [
				[ new THREE.Mesh( octahedronGeometry3, matHelper ), null, null, null, 'helper' ]
			],
			END: [
				[ new THREE.Mesh( octahedronGeometry3, matHelper ), null, null, null, 'helper' ]
			],
		...
		var gizmoRotate = {
			X: [
				[ new THREE.Line( circleGeometry, matLineRed ) ],
				[ new THREE.Mesh( octahedronGeometry4, matRed ), [ 0, 0, 0.99 ], null, [ 1, 3, 1 ] ],
			],
			Y: [
				[ new THREE.Line( circleGeometry, matLineGreen ), null, [ 0, 0, -Math.PI / 2 ] ],
				[ new THREE.Mesh( octahedronGeometry4, matGreen ), [ 0, 0, 0.99 ], null, [ 3, 1, 1 ] ],
			],
			Z: [
				[ new THREE.Line( circleGeometry, matLineBlue ), null, [ 0, Math.PI / 2, 0 ] ],
				[ new THREE.Mesh( octahedronGeometry4, matBlue ), [ 0.99, 0, 0 ], null, [ 1, 3, 1 ] ],
			],
			E: [
				[ new THREE.Line( circleGeometry2, matLineYellowTransparent ), null, [ 0, Math.PI / 2, 0 ] ],
				[ new THREE.Mesh( cylinderBufferGeometry2, matLineYellowTransparent ), [ 1.17, 0, 0 ], [ 0, 0, -Math.PI / 2 ], [ 1, 1, 0.001 ]],
				[ new THREE.Mesh( cylinderBufferGeometry2, matLineYellowTransparent ), [ -1.17, 0, 0 ], [ 0, 0, Math.PI / 2 ], [ 1, 1, 0.001 ]],
				[ new THREE.Mesh( cylinderBufferGeometry2, matLineYellowTransparent ), [ 0, -1.17, 0 ], [ Math.PI, 0, 0 ], [ 1, 1, 0.001 ]],
				[ new THREE.Mesh( cylinderBufferGeometry2, matLineYellowTransparent ), [ 0, 1.17, 0 ], [ 0, 0, 0 ], [ 1, 1, 0.001 ]],
			],
			XYZE: [
				[ new THREE.Line( circleGeometry3, matLineGray ), null, [ 0, Math.PI / 2, 0 ] ]
			]
		};
		...
		var pickerRotate = {
			X: [
				[ new THREE.Mesh( torusBufferGeometry, matInvisible ), [ 0, 0, 0 ], [ 0, -Math.PI / 2, -Math.PI / 2 ] ],
			],
			Y: [
				[ new THREE.Mesh( torusBufferGeometry, matInvisible ), [ 0, 0, 0 ], [ Math.PI / 2, 0, 0 ] ],
			],
			Z: [
				[ new THREE.Mesh( torusBufferGeometry, matInvisible ), [ 0, 0, 0 ], [ 0, 0, -Math.PI / 2 ] ],
			],
			E: [
				[ new THREE.Mesh( torusBufferGeometry2, matInvisible ) ]
			],
			XYZE: [
				[ new THREE.Mesh( sphereBufferGeometry, matInvisible ) ]
			]
		};
		...
		var gizmoScale = {
			...
			XYZX: [
				[ new THREE.Mesh( boxBufferGeometry, matWhiteTransperent ), [ 1.1, 0, 0 ] ],
			],
			XYZY: [
				[ new THREE.Mesh( boxBufferGeometry, matWhiteTransperent ), [ 0, 1.1, 0 ] ],
			],
			XYZZ: [
				[ new THREE.Mesh( boxBufferGeometry, matWhiteTransperent ), [ 0, 0, 1.1 ] ],
			]
		};

		var pickerScale = {
			X: [
				[ new THREE.Mesh( cylinderBufferGeometry, matInvisible ), [ 0.5, 0, 0 ], [ 0, 0, -Math.PI / 2 ] ]
			],
			Y: [
				[ new THREE.Mesh( cylinderBufferGeometry, matInvisible ), [ 0, 0.5, 0 ] ]
			],
			Z: [
				[ new THREE.Mesh( cylinderBufferGeometry, matInvisible ), [ 0, 0, 0.5 ], [ Math.PI / 2, 0, 0 ] ]
			],
			XY: [
			...
			XYZX: [
				[ new THREE.Mesh( boxBufferGeometry2, matInvisible ), [ 1.1, 0, 0 ] ],
			],
			XYZY: [
				[ new THREE.Mesh( boxBufferGeometry2, matInvisible ), [ 0, 1.1, 0 ] ],
			],
			XYZZ: [
				[ new THREE.Mesh( boxBufferGeometry2, matInvisible ), [ 0, 0, 1.1 ] ],
			]
		};
